...
| 指標                         | 解讀                   |
| -------------------------- | -------------------- |
| **Top-1 Accuracy = 0.659** | 約 66% 的查詢在第一名就選到正確目標 |
| **Mean Rank = 1.72**       | 正確目標平均排在第 1～2 名      |
| **MRR = 0.7966**           | 多數正確答案集中在前幾名         |
| **Recall@5 = 0.954**       | 95.4% 的正確答案在前 5 名    |
| **Recall@10 = 1.0**        | 所有正確答案都在前 10 名       |
| **Num. Queries = 6.47**    | 每組樣本平均約 6.5 個查詢物件    |
| **Num. Valid = 4.27**      | 其中約 4.3 個有對應的真實匹配    |
